...
execute_process(
  ...
  WORKING_DIRECTORY "C:/Users/t-xinden/.cpm/netxduo/0c1075509b3c47a37ae4bb2e75260dad004b3309"
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/t-xinden/.cpm/netxduo/0c1075509b3c47a37ae4bb2e75260dad004b3309/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/t-xinden/.cpm/netxduo/0c1075509b3c47a37ae4bb2e75260dad004b3309/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to update submodules in: 'C:/Users/t-xinden/.cpm/netxduo/0c1075509b3c47a37ae4bb2e75260dad004b3309/'")
  endif()
endif()
