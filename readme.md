...
To connect the Microchip E54 to Azure, you'll rebuild the image and flash the image to the device.
...
1. You will be promted to enter your Azure IoT device information from earlier. Follow the serial terminal prompt and you should see the program proceed via the **Termite** console.
